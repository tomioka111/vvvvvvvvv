...
case '':
 ...
 const needhelpmenu = `👋. مرحبا بك انا انوس البداية الخاص بي هيا. *${prefix}*`
...
const txt = `الامبراطور انوس بيحبك🌚❤️ / رقمي للتواصل معايا:https://api.whatsapp.com/send?phone=+967730348571    `
const mikuarray= [
