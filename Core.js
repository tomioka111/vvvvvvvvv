...
case '':
 ...
 const needhelpmenu = `مرحبا بك في بوت  الامبراطور انوس لظهور قائمه الاوامر اكتب -الاوامر او اضغط علي القائمه البادئه الخاصه بي هي *${prefix}*`
...
const txt = `حوده بيحبك🌚❤️ / رقمي للتواصل معايا:https://api.whatsapp.com/send?phone=+967730348571    `
const mikuarray= [
